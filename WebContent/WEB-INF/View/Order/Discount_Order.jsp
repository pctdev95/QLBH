				        ...
				        <div class="container">				        
				          ...
				          <form name="form" method="POST">
				            ...
				            <div class="products">
					                ...
					                <div class="form-group col-sm-9">
					                  ...
					                  <input id="card-number" type="text" class="form-control" aria-label="Card Holder" aria-describedby="basic-addon1" 
					               	...
					               	<div class="form-group col-sm-6">
				                  		...
				                  		<button type="submit" class="btn btn-dark btn-block" onclick="javascript: form.action='Discount_Order_Controller';">Discount this order</button>
				                	</div>
				                	
				                	<div class="form-group col-sm-6">
				                		<button type="submit" class="btn btn-dark btn-block" onclick="javascript: form.action='Donot_Discount_Controller';">Only payment</button>
					               	</div>
				              ...
				              <div class="total">Sum<span class="price" style="float: right;"><%= request.getAttribute("total")%></span></div>
				              <div class="total">Discount<span class="price" style="float: right;"><%= request.getAttribute("discountM")%></span></div>
				              <div class="total">Total<span class="price" style="float: right;"><%= request.getAttribute("afterdiscount")%></span></div>
				            </div>
