...
<body>
	<div class="row">
	  	...
	  	<div class="col-sm-10">
			...
			<form action="Add_Product_Type_Controller" method="POST" style="margin-left: 200px; margin-top:10px; width: 1000px; ">
			  <div class="form-row">
			  </div>
			  <div class="form-group">
			   Id Product type <input name="F_Id_PT" type="text" class="form-control" id="inputAddress" placeholder="ID Product type must be 5 character">
			  </div>
			  
			  <div class="form-group">
			   Name Product type <input name="F_Name_PT" type="text" class="form-control" id="inputAddress2" placeholder="Product type">
			  </div>
			  
			  <!-- <div class="form-group">
			    Decription Product type <input name="F_Decription_PT" type="text" class="form-control" id="inputAddress2" placeholder="Decription Product type">
			  </div> -->
			  
			  <div class="form-group">
				  <label for="comment">Decription:</label>
				  <textarea class="form-control" rows="5" id="comment" name="F_Decription_PT" placeholder="Decription Product type"></textarea>
			  </div>
